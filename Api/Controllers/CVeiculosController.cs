...
namespace Api.Controllers {
  ...
  public class CVeiculosController : ControllerBase {
    ...
    public async Task<IActionResult> Get() {
      using (_cVeiculos) {
        return Ok(_mapper.Map<IEnumerable<CVeiculoDto>>(await _cVeiculos.ListAsync()));
      }
    }
    ...
    public async Task<IActionResult> PagedList(int p, int k) {
      ...
      using (_cVeiculos) {
        return Ok(_mapper.Map<IEnumerable<CVeiculoDto>>(await _cVeiculos.PagedListAsync(skip: p, take: k)));
      }
    }
    ...
    public async Task<IActionResult> SelectList() {
      using (_cVeiculos) {
        return Ok(await _cVeiculos.SelectListAsync(v => new { v.Id, v.Classe }));
      }
    }
