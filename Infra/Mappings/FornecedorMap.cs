...
namespace Infra.Mappings {
  internal class FornecedorMap : IEntityTypeConfiguration<Fornecedor> {
    public void Configure(EntityTypeBuilder<Fornecedor> builder) {
      ...
      builder.ToTable("Fornecedores", "nfe");

      builder.Property(t => t.Id).HasColumnName("Id");
      builder.Property(t => t.Cnpj).HasColumnName("Cnpj").HasMaxLength(32);
      builder.Property(t => t.Cpf).HasColumnName("Cpf").HasMaxLength(16);
      ...
      builder.Property(t => t.Bairro).HasColumnName("Bairro").HasMaxLength(64);
      ...
      builder.Property(t => t.PaisId).HasColumnName("PaisId").IsRequired();
      ...
      builder.Property(t => t.IESubstituto).HasColumnName("IESubstituto").HasMaxLength(16);
      builder.Property(t => t.IMunicipal).HasColumnName("IMunicipal").HasMaxLength(16);
      builder.Property(t => t.Cnae).HasColumnName("Cnae").HasMaxLength(8);
      builder.Property(t => t.TributarioId).HasColumnName("TributarioId");
      builder.Property(t => t.Cadastro).HasColumnName("Cadastro");

      // Foreign Keys (Relationships)
      builder.HasOne(t => t.Municipio)
          .WithMany(f => f.Fornecedores).HasForeignKey(k => k.MunicipioId).IsRequired()
          .OnDelete(DeleteBehavior.Restrict);

      builder.HasOne(t => t.Pais)
          .WithMany(f => f.Fornecedores).HasForeignKey(k => k.PaisId).IsRequired()
          .OnDelete(DeleteBehavior.Restrict);
    }
  }
}
